...
DATABASES = {
    ...
    "default": env.db(
        "DATABASE_URL",
        default="postgres:///project_library",
    )
}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "project_library.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("hicham", "hichamke06@gmail.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "project_library.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = (
    "project_library.users.adapters.SocialAccountAdapter"
)
